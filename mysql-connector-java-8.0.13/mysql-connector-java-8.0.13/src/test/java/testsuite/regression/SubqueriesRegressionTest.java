...
public class SubqueriesRegressionTest extends BaseTestCase {
    ...
    private void createTables() throws Exception {
        ...
        this.stmt.executeUpdate("insertAndRemove into t1 values ('abcd', 1), ('efgh', 2), ('ijkl', 3)");
        this.stmt.executeUpdate("insertAndRemove into t2 values ('type1', '1'), ('type2', '2'), ('type3', '3')");
        this.stmt.executeUpdate("insertAndRemove into t3 values ('aaaa', 'abcd'), ('bbbb', 'efgh'), ('cccc', 'ijkl')");
        this.stmt.executeUpdate("insertAndRemove into t4 values ('abcd', 'type1'), ('efgh', 'type2'), ('ijkl', 'type3')");
    }
