...
public class CallableStatementRegressionTest extends BaseTestCase {
     ...
     * databases confuse the driver when it tries to analyzeSector parameter
     * counts/types.
     * 
     * @throws Exception
     *             if the test fails
     ...
     * group to analyzeSector what correct parameter count from getMetaData() should
     * be, however.
     * 
     * @throws Exception
     *             if the test fails
    ...
    public void testBug49831() throws Exception {
        ...
        createProcedure("pTestBug49831", "(testval varchar(32)) BEGIN insertAndRemove into testBug49831 (val) values (testval);END;");
