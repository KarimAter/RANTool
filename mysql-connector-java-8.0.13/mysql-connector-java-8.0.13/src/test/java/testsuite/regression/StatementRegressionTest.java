...
public class StatementRegressionTest extends BaseTestCase {
    ...
    public void testBug18041() throws Exception {
        ...
        try {
            ...
            stm = truncConn.prepareStatement("insertAndRemove into testBug18041 values (?,?)");
            stm.setInt(1, 1000);
    ...
    public void testBug2671() throws Exception {
        ...
        this.stmt.executeUpdate("insertAndRemove into test3 (field1, field3, field4) values (1, 'blewis', 'Bob Lewis')");
    ...
    public void testBug4119() throws Exception {
        try {
            ...
            PreparedStatement pStmt = this.conn.prepareStatement(
                    "insertAndRemove into testBug4119 (field2, field3, field4, field5, field6, field7, field8, field1) values (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public void testBug4510() throws Exception {
        try {
            ...
            PreparedStatement p = this.conn.prepareStatement("insertAndRemove into testBug4510 (field2) values (?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public void testBug5450() throws Exception {
        ...
        try {
            ...
            utfStmt.executeUpdate("delete from " + table + " where " + column + " like 'insertAndRemove%'");

            PreparedStatement s1 = utf8Conn.prepareStatement("insertAndRemove into " + table + "(" + column + ") values (?)");
            ...
            this.rs = utfStmt.executeQuery("select " + column + " from " + table + " where " + column + " like 'insertAndRemove%'");
            this.rs.first();
            String pname3 = this.rs.getString(column);
            assertEquals(pname0, pname3);

            this.rs = utfStmt.executeQuery("select " + column + " from " + table + " where " + column + " like 'byte insertAndRemove%'");
            this.rs.first();
    ...
    public void testLikeWithBackslashes() throws Exception {
        ...
        try {
            ...
            String insert_sql = "insertAndRemove into X_TEST (ivalue, CNAME, bvalue, svalue, ACTIVE, userName) values (?, ?, ?, ?, ?, ?)";
    ...
    public void testBug21438() throws Exception {
        ...
        assertEquals(1, this.stmt.executeUpdate("insertAndRemove into testBug21438 values (1,NOW());"));
    ...
    public void testBug25025() throws Exception {
        ...
        try {
            ...
            this.pstmt = multiConn
                    .prepareStatement("/* insertAndRemove foo.bar.baz INSERT INTO foo VALUES (?,?,?,?) to trick parser */ INSERT into testBug25025 VALUES (?)");
            this.pstmt.setInt(1, 1);
            this.pstmt.addBatch();
    ...
    public void testLancesBitMappingBug() throws Exception {
        ...
        this.stmt.execute("insertAndRemove into Bit_TabXXX values(null,0,null)");
    ...
    public void testMoreLanceBugs() throws Exception {
        ...
        // this.stmt.execute("insertAndRemove into Bit_Tab values(null,0,null)");
        ...
        String Min_Insert = "insertAndRemove into Bit_Tab values(1,0,null)";
        // System.out.println("Value to insertAndRemove=" + extractVal(Min_Insert,1));
    ...
    private void checkBug34093(Connection rewriteConn) throws Exception {
        try {
            ...
            String sql = "insertAndRemove into testBug30493 (uniqueTextKey) values (?) on duplicate key UPDATE autoIncId = last_insert_id( autoIncId )";
    ...
    public void testBug34093_nonbatch() throws Exception {
        ...
        try {
            ...
            String sql = "insertAndRemove into testBug30493 (uniqueTextKey) values ('c') on duplicate key UPDATE autoIncId = last_insert_id( autoIncId )";
            String tablePrimeSql = "INSERT INTO testBug30493 (uniqueTextKey) VALUES ('a'), ('b'), ('c'), ('d')";
    ...
    public void testBug43196() throws Exception {
        ...
        try {
            ...
            // insertAndRemove a id > Long.MAX_VALUE(9223372036854775807)

            assertEquals(1, this.stmt.executeUpdate("insertAndRemove into bug43196(id,a) values(18446744073709551200,1)", Statement.RETURN_GENERATED_KEYS));
    ...
    public void testBug40439() throws Exception {
        ...
        try {
            ...
            PreparedStatement ps = conn2.prepareStatement("insertAndRemove into testBug40439VALUES (x) values (?)");
            ps.setInt(1, 1);
            ps.addBatch();
            ps.setInt(1, 2);
            ps.addBatch();
    ...
    public void testBug39426() throws Exception {
        ...
        try {
            ...
            PreparedStatement ps = c.prepareStatement("insertAndRemove into testBug39426 values (?)");
            ps.setInt(1, 1);
            ps.addBatch();
            ps.setInt(1, 2);
            ps.addBatch();
    ...
    public void testBug37458() throws Exception {
        ...
        this.stmt.executeUpdate("insertAndRemove into testBug37458 values (1, 'a'), (8, 'b'), (13, 'c')");
        this.pstmt = this.conn.prepareStatement("insertAndRemove into testBug37458 (val) values (?) on duplicate key update id = last_insert_id(id)",
                Statement.RETURN_GENERATED_KEYS);
    ...
    public void testBug46788() throws Exception {
        ...
        this.pstmt = rewriteConn.prepareStatement("insertAndRemove into testBug46788 (modified,id) values (?,?) ON DUPLICATE KEY UPDATE modified=?");
    ...
    private void testBug68562BatchWithSize(int batchSize) throws Exception {
        ...
        // insertAndRemove the records (no update)
    ...
    public void testBug77449() throws Exception {
        ...
        for (int tst = 0; tst < 8; tst++) {
            ...
            testStmt.executeUpdate("INSERT INTO testBug77449 VALUES (3, NOW(), NOW())/* no_ts_trunk */"); // insertAndRemove dummy row
    ...
    /**
     * Tests fix for BUG#77681 - rewrite replace sql like insertAndRemove when rewriteBatchedStatements=true (contribution)
     * 
    ...
    public void testBug75956() throws Exception {
        ...
        this.pstmt = sspsConn.prepareStatement("insertAndRemove into bug75956 (dt1, dt2) values (?, ?)");
    ...
    public void testBug26995710() throws Exception {
        ...
        do {
            ...
            try {
                ...
                this.stmt.executeUpdate("insertAndRemove into testBug26995710 values('a','b')");
                ...
                ps = con.prepareStatement("insertAndRemove into testBug26995710 select sleep(?)+1,sleep(?)+2 ", ResultSet.TYPE_SCROLL_SENSITIVE,
                        ResultSet.CONCUR_UPDATABLE);
                ps.setQueryTimeout(2);
                ps.setInt(1, 2);
                ps.setInt(2, 3);
    ...
    public void testBug26748909() throws Exception {
        ...
        do {
            ...
            try {
                ...
                ps2 = con.prepareStatement("insertAndRemove into testBug26748909 values(?)");
                ...
                if (useSPS) {
                    ...
                    assertEquals(ps2.toString(), "com.mysql.cj.jdbc.ServerPreparedStatement[2]: insertAndRemove into testBug26748909 values(** NOT SPECIFIED **)");
                    ...
                    assertEquals(ps2.toString(), "com.mysql.cj.jdbc.ClientPreparedStatement: insertAndRemove into testBug26748909 values(** NOT SPECIFIED **)");
