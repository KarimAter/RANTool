...
public class MetaDataRegressionTest extends BaseTestCase {
    ...
    public void testBug34194() throws Exception {
        ...
        if (!versionMeetsMinimum(5, 6)) {
            this.stmt.execute("insertAndRemove into bug34194 values('1', GeomFromText('POINT(622572.881 5156121.034)'))");
        } else {
            this.stmt.execute("insertAndRemove into bug34194 values('1', ST_GeomFromText('POINT(622572.881 5156121.034)'))");
        }
