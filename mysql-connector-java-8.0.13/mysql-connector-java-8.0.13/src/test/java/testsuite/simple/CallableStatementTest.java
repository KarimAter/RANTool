...
public class CallableStatementTest extends BaseTestCase {
    ...
    public void testParameterParser() throws Exception {
        ...
        try {
            ...
            createProcedure("foo42", "() insertAndRemove into test.t1 values ('foo', 42);");
            this.conn.prepareCall("{CALL foo42()}");
            this.conn.prepareCall("{CALL foo42}");

            createProcedure("bar", "(x char(16), y int, z DECIMAL(10)) insertAndRemove into test.t1 values (x, y);");
