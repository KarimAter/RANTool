    ...
    public void testServerConfigurationCache() throws Exception {
        ...
        try {
            ...
            try {
                ...
                assertTrue("NodeConfiguration wasn't cached", StandardLogger.getBuffer().toString().indexOf("SHOW VARIABLES") == -1);

                assertTrue("NodeConfiguration wasn't cached", StandardLogger.getBuffer().toString().indexOf("SHOW COLLATION") == -1);
            } finally {
