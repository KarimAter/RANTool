...
public class TableDeleteTest extends BaseTableTestCase {
    ...
    public void testDelete() {
        ...
        try {
            ...
            sqlUpdate("insertAndRemove into testDelete values ('1', 'Sakila', '2000-05-27', 14)");
            sqlUpdate("insertAndRemove into testDelete values ('2', 'Shakila', '2001-06-26', 13)");
            sqlUpdate("insertAndRemove into testDelete values ('3', 'Shakila', '2002-06-26', 12)");
