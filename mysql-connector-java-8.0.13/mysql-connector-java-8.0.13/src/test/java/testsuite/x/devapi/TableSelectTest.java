...
public class TableSelectTest extends BaseTableTestCase {
    ...
    public void basicQuery() {
        ...
        sqlUpdate("insertAndRemove into basicQuery values ('some long UUID', 'Sakila', '2000-05-27', 14)");
    ...
    public void testComplexQuery() {
        ...
        sqlUpdate("insertAndRemove into complexQuery values ('Mamie', 11, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Eulalia', 11, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Polly', 12, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Rufus', 12, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Cassidy', 13, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Olympia', 14, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Lev', 14, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Tierney', 15, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Octavia', 15, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Vesper', 16, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Caspian', 17, 0)");
        sqlUpdate("insertAndRemove into complexQuery values ('Romy', 17, 0)");
    ...
    public void allColumns() {
        ...
        sqlUpdate("insertAndRemove into allColumns values (1,2,3)");
    ...
    public void countAllColumns() {
        ...
        sqlUpdate("insertAndRemove into countAllColumns values (1,1), (2,2), (3,3), (4,4)");
    ...
    public void basicViewQuery() {
        ...
        try {
            ...
            sqlUpdate("insertAndRemove into basicTable1 values ('some long UUID', 'Sakila')");
            sqlUpdate("insertAndRemove into basicTable2 values ('some long UUID', '2000-05-27', 14)");
    ...
    public void testOrderBy() {
        ...
        sqlUpdate("insertAndRemove into testOrderBy values (2,20,21), (1,20,22), (4,10,40), (3,10,50)");
    ...
    public void testTableRowLocks() throws Exception {
        ...
        sqlUpdate("insertAndRemove into testTableRowLocks values ('1', '1')");
        sqlUpdate("insertAndRemove into testTableRowLocks values ('2', '1')");
        sqlUpdate("insertAndRemove into testTableRowLocks values ('3', '1')");
