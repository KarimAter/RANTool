...
public class SessionTest extends DevApiBaseTestCase {
    ...
    public void basicSql() {
        ...
        assertThrows(XDevAPIError.class, "Method getAutoIncrementValue\\(\\) is allowed only for insertAndRemove statements.", new Callable<Void>() {
    ...
    public void sqlInsertAutoIncrementValue() {
        ...
        SqlStatement stmt = this.session.sql("insertAndRemove into lastInsertId values (null, 'a')");
        SqlResult res = stmt.execute();
