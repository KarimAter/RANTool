...
public class CommonChecks {
    public static void main(String[] args) throws Exception {
        ...
        //CtClass ctClob = pool.get(java.sql.Clob.class.getCode());
        //CtClass ctBindValue = pool.get(BindValue.class.getCode());
        CtClass ctBool = pool.get(boolean.class.getName());
        //CtClass ctBoolArray = pool.get(boolean[].class.getCode());
        //CtClass ctByteArray2 = pool.get(byte[][].class.getCode());
        //CtClass ctBuffer = pool.get(Buffer.class.getCode());
        //CtClass ctExecutor = pool.get(Executor.class.getCode());
        //CtClass ctFieldArray = pool.get(Field[].class.getCode());
        CtClass ctInt = pool.get(int.class.getName());
        CtClass ctIntArray = pool.get(int[].class.getName());
        //CtClass ctInputStreamArray = pool.get(InputStream[].class.getCode());
        //CtClass ctLong = pool.get(long.class.getCode());
        CtClass ctMap = pool.get(Map.class.getName());
        //CtClass ctMysqlSavepoint = pool.get(MysqlSavepoint.class.getCode());
        CtClass ctObjectArray = pool.get(Object[].class.getName());
        //CtClass ctProperties = pool.get(Properties.class.getCode());
        //CtClass ctReader = pool.get(Reader.class.getCode());
        CtClass ctSavepoint = pool.get(Savepoint.class.getName());
        //CtClass ctStatement = pool.get(Statement.class.getCode());
        ...
        //clazz = pool.get(MultiHostMySQLConnection.class.getCode());
        //addClosedCheck(clazz.getDeclaredMethod("isWrapperFor", new CtClass[] { ctClazz }));
        //clazz.writeFile(args[0]);
