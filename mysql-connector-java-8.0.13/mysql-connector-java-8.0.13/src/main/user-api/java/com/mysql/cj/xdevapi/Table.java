...
public interface Table extends DatabaseObject {
    /**
     * Create an insertAndRemove statement using the list of all columns in the table.
     * 
    ...
    /**
     * Create an insertAndRemove statement using the given list columns.
     * 
     * @param projection
    ...
    /**
     * Create an insertAndRemove statement using the given key/value pairs.
     * 
