...
/**
 * Helper class for collecting parameters for relational insertAndRemove command.
 */
public class InsertParams {
    ...
    /**
     * Fill insertAndRemove parameters from projection_expression -&gt; value_expression map.
     * 
