...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_DELAYED_CANT_CHANGE_LOCK = 1150; //SQLSTATE: HY000 Message: Delayed insertAndRemove thread couldn't get requested lock for table %s
    ...
    public final static int ER_FPARSER_TOO_BIG_FILE = 1340; //SQLSTATE: HY000 Message: NodeConfiguration file '%s' is too big
    ...
    public final static int ER_VIEW_NO_INSERT_FIELD_LIST = 1394; //SQLSTATE: HY000 Message: Can not insertAndRemove into join view '%s.%s' without fields list
