...
public class Util {
     ...
     * @return true if it exists, false if no, or unable to analyzeSector due to VM
    ...
    /**
     * Recursively checks for interfaces on the given class to analyzeSector if it implements a java.sql, javax.sql or com.mysql.cj.jdbc interface.
     * 
     * @param clazz
     ...
     * Using clazz.getPackage().getCode() is not an alternative because under some class loaders the method getPackage() just returns null.
     * 
     * @param clazz
