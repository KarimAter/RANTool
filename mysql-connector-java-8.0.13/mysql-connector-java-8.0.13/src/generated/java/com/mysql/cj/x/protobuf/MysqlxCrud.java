...
public final class MysqlxCrud {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum UpdateType
      ...
      /**
       * <pre>
       * insertAndRemove the value in the array at the index identified in the source path
       * </pre>
       *
   ...
   * :param collection: collection to insertAndRemove into
   ...
   * :param collection: collection to insertAndRemove into
   * :param data_model: datamodel that the operations refer to
   * :param projection: name of the columns to insertAndRemove data into (empty if data_model is DOCUMENT)
   * :param row: set of rows to insertAndRemove into the collection/table (a single expression with a JSON document literal or an OBJECT expression)
